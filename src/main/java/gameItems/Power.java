...
/**
 * Een powerup die iets in het spel veranderd waardoor het moeilijker of makkelijker wordt
 *
 */
...
public class Power extends GameObject implements ICollidableWithGameObjects {
	...
	public Power(float x, float y, float width, float height, BreakTheWall world, int dropChance, int goodChance) {
	...
	/**
	 * Kies of powerup goed of slecht is
	 *
	 */
	...
	/**
	 * Kijk of er een powerup getekend moet worden
	 *
	 */
